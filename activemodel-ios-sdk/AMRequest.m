...
static NSString* kUserAgent = @"AMConnect";
static NSString* kStringBoundary = @"xXxBoUnDaRyxXx";
static const int kGeneralErrorCode = 10000;

static const NSTimeInterval kTimeoutInterval = 120.0;

NSString* const InstagramErrorDomain = @"amErrorDomain";

@implementation AMRequest
...
+ (AMRequest *)getRequestWithParams:(NSMutableDictionary *) params
    ...
    AMRequest* request = [[AMRequest alloc] init];
...
- (void)failWithError:(NSError *)error {
    ...
    self.state = AMRequestStateError;
}
...
- (void)connect {
    ...
    self.state = AMRequestStateLoading;
}
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    if (self.state != AMRequestStateError) {
        self.state = AMRequestStateComplete;
    }
}
